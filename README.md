...
Оркестратор ── один LLM-вызов с tool calling, роутит запрос
   ...
   └── Coach     — недельное ревью, адаптивная
                   нагрузка без штрафов                 [готов]
   ▼
...
- [x] Coach: недельное ревью по метрикам (скользящее среднее вместо стриков),
      адаптивная нагрузка с применением в один клик
